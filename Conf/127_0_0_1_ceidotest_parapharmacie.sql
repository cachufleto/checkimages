--
-- Base de données :  `ceidotest_parapharmacie`
--
CREATE DATABASE IF NOT EXISTS `ceidotest_parapharmacie` DEFAULT CHARACTER SET utf16 COLLATE utf16_general_ci;
USE `ceidotest_parapharmacie`;
