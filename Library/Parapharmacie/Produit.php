...
require MOD . 'Parapharmacie.php';
use Model\Parapharmacie;

class Produit extends Parapharmacie
{
    ...
    public function imgProd($_img, $nom){
        ...
        if ($img['image'] == 1 && $img['vignette'] == 1) {
            return '<img height="150px" src="https://www.pharmaplay.fr/p/produits/' . $nom . '_vig.jpg" alt="' . $nom . ' Vignette"  border="0" />'
            . '<img height="250px" src="https://www.pharmaplay.fr/p/produits/' . $nom . '.jpg" alt="' . $nom . ' Grande"  border="0" />';
        } else if ($img['image'] == 1) {
            return '<img height="150px" src="https://www.pharmaplay.fr/p/produits/' . $nom . '.jpg" alt="' . $nom . ' Grande"  border="0" />';
    ...
    public function testImage($nom){
        ...
        $_grand = remote_file_exists('https://www.pharmaplay.fr/p/produits/' . $nom . '.jpg');
        $_vignette = remote_file_exists('https://www.pharmaplay.fr/p/produits/' . $nom . '_vig.jpg');
        ...
        if ($_grand && $_vignette) {
            ...
            return '<img height="250px" src="https://www.pharmaplay.fr/p/produits/' . $nom . '.jpg" alt="' . $nom . ' Grande"  border="0" />';
        } else if ($_vignette) {
